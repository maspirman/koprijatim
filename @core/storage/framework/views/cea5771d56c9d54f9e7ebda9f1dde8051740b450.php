...
<?php $__env->startSection('section'); ?>
       <div class="headerbtn-wrap d-flex justify-content-between margin-bottom-50">
           <h3 class="header-title"><?php echo e(__('Edit Surat')); ?></h3>
           <a href="<?php echo e(route('user.letter.all')); ?>" class="btn btn-info"><?php echo e(__('Kembali ke List Surat')); ?></a>
       </div>
        <form action="<?php echo e(route('user.letter.update')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <label for="title"><?php echo e(__('Judul')); ?></label>
                                        <input type="text" class="form-control"  id="title" name="title" value="<?php echo e($letter->name); ?>" placeholder="<?php echo e(__('Title')); ?>">
                                    </div>
                                    ...
                                    <div class="form-group permalink_label">
                                        ...
                                        <input type="text" name="slug" value="<?php echo e($letter->slug); ?>" class="form-control blog_slug mt-2" style="display: none">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="event_name" name="event_name" value="<?php echo e($letter->title); ?>" placeholder="<?php echo e(__('Nama Acara')); ?>">
                                            </div>
                                        </div>
                                       <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="category_event_id" class="form-control" id="category_event">
                                                    ...
                                                    <?php $__currentLoopData = $all_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($category->id); ?>" <?php if($category->id == $letter->category_id): ?> selected <?php endif; ?>>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <select name="category_letter_id" class="form-control" id="category_letter">
                                                    ...
                                                    <?php $__currentLoopData = $all_temp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $templates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                     <option value="<?php echo e($templates->id); ?>" <?php if($templates->id == $letter->temp_id): ?> selected <?php endif; ?>>
                                                            <?php echo e($templates->name); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="letter_no"><?php echo e(__('No Surat')); ?></label>
                                                <input type="text" class="form-control"  id="letter_no" name="letter_no" value="<?php echo e($letter->letter_no); ?>" placeholder="<?php echo e(__('Nomor Surat')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="target"><?php echo e(__('Kepada *')); ?></label>
                                                <input type="text" class="form-control"  id="target" name="letter_target" value="<?php echo e($letter->target); ?>" placeholder="<?php echo e(__('Kepada Yth')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                             <div class="form-group">
                                                <label for="lesson_title"><?php echo e(__('Judul Materi *')); ?></label>
                                                <input type="text" class="form-control"  id="letter_materi" name="lesson_materi" value="<?php echo e($letter->lesson_title); ?>" placeholder="<?php echo e(__('Judul Materi')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="letter_opening" value="<?php echo e($letter->letter_opening); ?>" >
                                                <div class="summernote" id="opener-summernote" data-content="<?php echo e($letter->letter_opening); ?>"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label><?php echo e(__('Isi Surat *')); ?></label>
                                                <input type="hidden" name="letter_content" value="<?php echo e($letter->letter_content); ?>" >
                                                <div class="summernote" id="content-summernote" data-content="<?php echo e($letter->letter_content); ?>"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                              <div class="form-group">
                                                ...
                                                <input type="hidden" name="letter_closing" value="<?php echo e($letter->letter_closing); ?>" >
                                                <div class="summernote" id="closing-summernote" data-content="<?php echo e($letter->letter_closing); ?>"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="event_content" value="<?php echo e($letter->content); ?>" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  id="time" name="time" value="<?php echo e($letter->time); ?>" placeholder="<?php echo e(__('time')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="date"><?php echo e(__('Tanggal Mulai *')); ?></label>
                                                <input type="date" date-format="dd-mm-yyy" class="form-control datepicker"  id="date" name="date" value="<?php echo e($letter->date); ?>" placeholder="<?php echo e(__('Date')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="date"><?php echo e(__('Tanggal Selesai')); ?></label>
                                                <input type="date" class="form-control datepicker"  id="date_end" name="date_end" value="<?php echo e($letter->date_end); ?>" placeholder="<?php echo e(__('Date')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control"  id="cost" name="cost" value="<?php echo e($letter->cost); ?>" placeholder="<?php echo e(__('cost')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="available_tickets"><?php echo e(__('Jumlah Kursi *')); ?></label>
                                                <input type="number" class="form-control"  id="available_tickets" name="available_tickets" value="<?php echo e($letter->available_tickets); ?>" placeholder="<?php echo e(__('available tickets')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  id="organizer" name="organizer" value="<?php echo e($letter->organizer); ?>" placeholder="<?php echo e(__('Event Organizer')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="organizer_email"><?php echo e(__('Organizer Email')); ?></label>
                                                <input type="text" class="form-control"  id="organizer_email" name="organizer_email" value="<?php echo e($letter->organizer_email); ?>" placeholder="<?php echo e(__('Organizer Email')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                             <div class="form-group">
                                                <label for="organizer_phone"><?php echo e(__('Organizer Phone')); ?></label>
                                                <input type="text" class="form-control"  id="organizer_phone" name="organizer_phone" value="<?php echo e($letter->organizer_phone); ?>" placeholder="<?php echo e(__('Organizer Phone')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  id="venue" name="venue" value="<?php echo e($letter->venue); ?>" placeholder="<?php echo e(__('Tempat Event')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="venue_location"><?php echo e(__('Maps Location')); ?></label>
                                                <input type="text" class="form-control"  id="venue_location" name="venue_location" value="<?php echo e($letter->venue_location); ?>" placeholder="<?php echo e(__('Maps Location')); ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="meta_title"  value="<?php echo e($letter->meta_title); ?>" class="form-control" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="meta_tags"><?php echo e(__('Meta Tags')); ?><small> (pisahkan dengan koma (,))</small></label>
                                                <input type="text" name="meta_tags" value="<?php echo e($letter->meta_tags); ?>"  class="form-control" data-role="tagsinput" id="meta_tags">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="meta_description"><?php echo e(__('Meta Description')); ?></label>
                                        <textarea name="meta_description"  class="form-control" rows="5" id="meta_description"><?php echo e($letter->meta_description); ?></textarea>
                                    </div>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/frontend/user/dashboard/letter/edit-letter.blade.php ENDPATH**/ ?>