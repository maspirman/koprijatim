            ...
            <div class="col-xl-5 col-lg-7">
                <div class="help-and-support-left">
                    <div class="section-title margin-bottom-35">
                        ...
                        <div class="description" style="text-align: justify;"><?php echo filter_static_option_value('home_page_01_about_us_description',$static_field_data); ?></div>
                    </div>
                    <div class="content" style="text-align: justify;">
                        ...
                        <ul>
                            <?php $__currentLoopData = $_about_us_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li style="font-size: 24px;"><i class="fas fa-building"></i> <?php echo e($item); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                </div>
...
<div class="our-latest-area padding-top-10">
    <div class="container">
        <div class="row justify-content-center">
    ...
    <div class="row">
        <div class="global-carousel-init slider-dots"
             ...
             data-autoplay="true"
        >
            <?php $__currentLoopData = $upcoming_events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
    ...
    <center>
            <br>
            <a href="#" class="btn btn-primary mb-5">Jelajahi Semua Upcoming Event</a>
            <br>
        </center>
            <?php else: ?>
              <center>
                  <h4>Mohon maaf event belum tersedia.</h4>
                  <p>Tunggu update dari kami ya..</p>
                  <br><hr>
              </center>
                  <?php endif; ?>
</div>
                    ...
                    <?php $__currentLoopData = $all_testimonial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="single-testimonial-item dark">
                            ...
                            <div class="content">
                                ...
                                <h2 class="description"><?php echo e($data->description); ?></h2>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php endif; ?>
        ...
        <center>
            <br>
            <a href="#" class="btn btn-primary">Jelajahi Semua Pengurus</a>
        </center>
    </div>
</section>
<?php endif; ?>
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="attend-title-content margin-bottom-50">
                    ...
                    <div class="section-paragraph">
                        <div class="event-nav-container2"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="global-carousel-init slider-dots"
                 ...
                 data-tabletitem="1"
                 data-nav="true"
                 data-navcontainer=".event-nav-container2"
                 data-dots="true"
                 data-margin="30"
                 data-autoplay="true"
            >
...
<?php endif; ?>
        ...
        <center>
            <br>
            <a href="#" class="btn btn-primary">Jelajahi Semua Event</a>
        </center>
    </div>
</section>
<?php endif; ?>
...
<section class="blog-area bg-image padding-top-15 padding-bottom-120" style="background-image: url(<?php echo e(asset('assets/frontend/img/shape/03.png')); ?>);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title desktop-center margin-bottom-50">
...
<?php endif; ?>
        ...
        <center>
            <br>
            <a href="#" class="btn btn-primary">Jelajahi Semua Artikel</a>
        </center>
    </div>
</section>
<!-- blog area end -->
 <?php endif; ?><?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/frontend/home-pages/home-03.blade.php ENDPATH**/ ?>