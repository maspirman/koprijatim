                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li
                        ...
                        <?php if(request()->is(['admin-home/frontend/new-user','admin-home/frontend/all-user','admin-home/frontend/all-user/role'])): ?> active <?php endif; ?>
                                    ">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i>
                            <span><?php echo e(__('Kelola Cabang')); ?></span></a>
                        <ul class="collapse">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-list')): ?>
                                <li class="<?php echo e(active_menu('admin-home/frontend/all-user')); ?>"><a
                                            href="<?php echo e(route('admin.all.frontend.user')); ?>"><?php echo e(__('Semua Cabang')); ?></a></li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('branch-create')): ?>
                                <li class="<?php echo e(active_menu('admin-home/frontend/new-user')); ?>"><a
                                            href="<?php echo e(route('admin.frontend.new.user')); ?>"><?php echo e(__('Buat Cabang Baru')); ?></a></li>
                            <?php endif; ?>
                        </ul>
 ...
 -->
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['newsletter-list','support-ticket-create','support-ticket-category-index','support-ticket-page-settings'])): ?>
                    ...
                    >
                        ...
                        <ul class="collapse">
                            ...
                            <li class="<?php echo e(active_menu('admin-home/support-tickets')); ?>">
                                <a href="<?php echo e(route('admin.support.ticket.all')); ?>"><?php echo e(__('Semua Tiket')); ?></a></li>
                           <?php endif; ?>
                            ...
                            <li class="<?php echo e(active_menu('admin-home/support-tickets/new')); ?>"><a
                                        href="<?php echo e(route('admin.support.ticket.new')); ?>"><?php echo e(__('Tambah Tiket Pengaduan')); ?></a></li>
                            <?php endif; ?>
                            ...
                            <li class="<?php echo e(active_menu('admin-home/support-tickets/page-settings')); ?>"><a
                                        href="<?php echo e(route('admin.support.ticket.page.settings')); ?>"><?php echo e(__('Settings')); ?></a></li>
                             <?php endif; ?>
                        </ul>
                    </li>
                 <?php endif; ?>
                 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['support-ticket-category-index','support-ticket-page-settings'])): ?>
                    ...
                    >
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-support mr-2"></i>
                            <?php echo e(__('Organisasi')); ?></a>
                        <ul class="collapse">
                           
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('support-ticket-category-index')): ?>
                            <li class=""><a
                                        href="<?php echo e(route('admin.support.ticket.department')); ?>"><?php echo e(__('Department')); ?></a></li>
                             <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('support-ticket-category-index')): ?>
                            <li class=""><a
                                        href="<?php echo e(route('admin.support.ticket.department')); ?>"><?php echo e(__('Penunjukan')); ?></a></li>
                             <?php endif; ?>
                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('support-ticket-page-settings')): ?>
                            <li class=""><a
                                        href="<?php echo e(route('admin.support.ticket.page.settings')); ?>"><?php echo e(__('Posisi/Jabatan')); ?></a></li>
                             <?php endif; ?>
                        </ul>
                    </li>
                 <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>