        ...
        <?php if(!empty(get_static_option('events_module_status'))): ?>
            <div class="col-lg-6">
                <div class="user-dashboard-card margin-bottom-30">
                    ...
                    <div class="content">
                        <h4 class="title"><?php echo e(get_static_option('events_page_name')); ?> <?php echo e(__('Yang Dibooking')); ?></h4>
 ...
 -->
        <div class="col-lg-6">
            <div class="user-dashboard-card style-01">
                <div class="icon"><i class="fas fa-calendar-alt"></i></div>
                <div class="content">
                    <h4 class="title"><?php echo e(__('Total')); ?> <?php echo e(__('Surat')); ?></h4>
                    <span class="number"><?php echo e($letters); ?></span>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/frontend/user/dashboard/user-home.blade.php ENDPATH**/ ?>