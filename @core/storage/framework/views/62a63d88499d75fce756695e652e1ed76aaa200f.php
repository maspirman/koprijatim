                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu bell-notify-box notify-box">
                                    <?php if(count($new_notification) > 0): ?>
                                        <span class="notify-title"><?php echo e(sprintf('Anda memiliki %s notifikasi baru',count($new_notification))); ?>

                                            <a href="<?php echo e(route('admin.notification')); ?>"><?php echo e(__('semua')); ?></a>
                                        </span>
                                    <?php else: ?>
                                        <span class="notify-title"><?php echo e(__('Anda tidak memiliki notifikasi baru')); ?>

                                            <a href="<?php echo e(route('admin.notification')); ?>">
                                                <?php echo e(__('Semua')); ?></a>
                                        </span>
                                    <?php endif; ?>
                                    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 380px;">
                                        <div class="nofity-list">

                                            <?php $__currentLoopData = $all_notifiacations->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                ...
                                                <a href="<?php echo e(route('admin.notification.view',$item->id)); ?>" class="notify-item <?php echo e($seen_condition); ?>">
                                                    ...
                                                    <div class="notify-text">
                                                        ...
                                                        <?php elseif($item->type == 'user_campaign'): ?>
                                                         ...
                                                         <?php elseif($item->type == 'user_letter'): ?>
                                                            <p class="pera"><?php echo e(optional($item->user_letter)->title); ?></p>
                                                         <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/backend/admin-master.blade.php ENDPATH**/ ?>