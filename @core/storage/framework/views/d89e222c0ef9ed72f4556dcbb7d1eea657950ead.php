...
<?php endif; ?>
        ...
        <nav class="navbar navbar-area navbar-expand-lg has-topbar nav-style-02">
            <div class="container nav-container">
                ...
                <div class="collapse sticky navbar-collapse" id="bizcoxx_main_menu">
                    <ul class="navbar-nav">
                          ...
                          <?php if(!empty(get_static_option('home_page_navbar_search_show_hide'))): ?>
                            <div class="search navbar-search position-relative">
                                ...
                                <div class="search-bar">
                                    <form class="menu-search-form" action="<?php echo e(route('frontend.events.search')); ?>">
...
<?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/frontend/partials/navbar.blade.php ENDPATH**/ ?>