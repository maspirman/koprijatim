...
<?php
    $button_url =  !empty(filter_static_option_value('home_page_navbar_button_url',$global_static_field_data)) ? filter_static_option_value('home_page_navbar_button_url',$global_static_field_data) : route('frontend.letter.user');
?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/components/front-donate-btn.blade.php ENDPATH**/ ?>