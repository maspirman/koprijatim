                        ...
                        <div class="order-tab-wrap">
                            ...
                            <div class="tab-content" >
                                ...
                                <div class="tab-pane fade <?php if(auth()->check()): ?> show active <?php endif; ?>" id="nav-profile" role="tabpanel">
                                    ...
                                    <?php endif; ?>
                                    <form method="post" action="<?php echo e(route('frontend.event.payment.confirm')); ?>" enctype="multipart/form-data">
                                        ...
                                        <?php if(!empty($event->cost) && $event->cost > 0): ?>
                                            ...
                                            <div class="form-group manual_pay_box d-none">
                                                    <input class="form-control btn btn-info btn-sm pb-2 pt-2" type="file" name="manual_payment_attachment">
            ...
            $(document).ready(function ($) {
                ...
                $(document).on('click','.payment-gateway-wrapper > ul > li',function (e) {
                    ...
                    if(gateway == 'manual_payment'){
                        $('.manual_pay_box').removeClass('d-none');
                    }else{
                        $('.manual_pay_box').addClass('d-none');
                    }
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/frontend/events/event-booking.blade.php ENDPATH**/ ?>