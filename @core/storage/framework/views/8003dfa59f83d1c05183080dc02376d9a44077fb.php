...
<?php $__env->startSection('content'); ?>
    <section class="login-page-wrapper">
        <div class="container">
                    ...
                    <div class="user-dashboard-wrapper">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <?php if(!empty(get_static_option('events_module_status'))): ?>
                                <li class="nav-item">
                                    <a class="nav-link <?php if(request()->routeIs('user.home.event.booking')): ?> active <?php endif; ?>" href="<?php echo e(route('user.home.event.booking')); ?>"><?php echo e(__('Riwayat Event')); ?></a>
                                </li>
                            <?php endif; ?>
          ...
          <!--                 <?php if(Auth::guard('web')->user()->campaign_permission == 'on'): ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php if( request()->routeIs('user.campaign.gift.all') || request()->routeIs('user.campaign.gift.new') ||request()->routeIs('user.campaign.gift.edit')): ?> active <?php endif; ?> " href="<?php echo e(route('user.campaign.gift.all')); ?>"><?php echo e(__('Campaign Gifts')); ?></a>
                            </li>
 ...
 -->
                            <li class="nav-item">
                                <a class="nav-link <?php if( request()->routeIs('user.leeter.all') || request()->routeIs('user.letter.new') ||request()->routeIs('user.letter.edit')): ?> active <?php endif; ?> " href="<?php echo e(route('user.letter.all')); ?>"><?php echo e(__('Surat List')); ?></a>
                            </li>
                     ...
                     <!--        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php if(request()->routeIs('user.home.support.tickets')): ?> active <?php endif; ?>" href="<?php echo e(route('user.home.support.tickets')); ?>" ><?php echo e(__('Semua Tiket Pengaduan')); ?> </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php if(request()->routeIs('user.home.verify.update')): ?> active <?php endif; ?> " href="<?php echo e(route('user.home.verify.update')); ?>"><?php echo e(__('Verifikasi Data')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php if(request()->routeIs('user.home.change.password')): ?> active <?php endif; ?> " href="<?php echo e(route('user.home.change.password')); ?>"><?php echo e(__('Ubah Password')); ?></a>
                            </li>
                            <!-- <li class="nav-item">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/frontend/user/dashboard/user-master.blade.php ENDPATH**/ ?>