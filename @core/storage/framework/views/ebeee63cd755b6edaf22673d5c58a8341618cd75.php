<?php $__env->startSection('site-title'); ?>
    <?php echo e(get_static_option('image_gallery_page_name')); ?>
...
<?php $__env->startSection('page-meta-data'); ?>
    <meta name="description" content="<?php echo e(get_static_option('image_gallery_page_meta_description')); ?>">
    <meta name="tags" content="<?php echo e(get_static_option('image_gallery_page_meta_tags')); ?>">
<?php $__env->stopSection(); ?>
                   ...
                   <div class="case-studies-masonry-wrapper">
                       <ul class="case-studies-menu style-01">
                           ...
                           <?php $__currentLoopData = $all_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <li data-filter=".<?php echo e(Str::slug($data->title)); ?>"><?php echo e(purify_html($data->title)); ?></li>
                           ...
                           <?php $__currentLoopData = $all_gallery_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <div class="col-lg-4 col-md-6 masonry-item <?php echo e(Str::slug(get_image_category_name_by_id($data->cat_id))); ?>">
                                   <div class="single-gallery-image ">
                                       ...
                                       <div class="img-hover">
                                           <a href="<?php echo e($img_url); ?>" title="<?php echo e(purify_html($data->title)); ?>" class="image-popup">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koprijatim.or.id\@core\resources\views/frontend/pages/image-gallery.blade.php ENDPATH**/ ?>