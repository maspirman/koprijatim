...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut berisi pesan-pesan kesalahan validasi default yang digunakan oleh
    | kelas validator. Beberapa aturan ini memiliki beberapa versi seperti aturan-aturan ukuran.
    | Anda bebas untuk mengubah pesan-pesan ini di sini.
    |
    */
    ...
    | konvensi "attribute.rule" untuk memberi nama baris bahasa khusus untuk aturan atribut tertentu.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut digunakan untuk mengganti tempat tanda placeholder atribut kami
