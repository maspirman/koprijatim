            ...
            <div class="col-xl-5 col-lg-7">
                <div class="help-and-support-left">
                    <div class="section-title margin-bottom-35">
                        ...
                        <div class="description" style="text-align: justify;">{!! filter_static_option_value('home_page_01_about_us_description',$static_field_data) !!}</div>
                    </div>
                    <div class="content" style="text-align: justify;">
                        ...
                        <ul>
                            @foreach($_about_us_list as $item)
                                <li style="font-size: 24px;"><i class="fas fa-building"></i> {{$item}}</li>
                            @endforeach
                        </ul>
                    </div>
                </div>
...
<section class="blog-area bg-image padding-top-15 padding-bottom-120" style="background-image: url({{asset('assets/frontend/img/shape/03.png')}});">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title desktop-center margin-bottom-50">
