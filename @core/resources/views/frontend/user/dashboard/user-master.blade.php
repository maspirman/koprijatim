...
@section('content')
                    ...
                    <div class="user-dashboard-wrapper">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            @if(!empty(get_static_option('events_module_status')))
                                <li class="nav-item">
                                    <a class="nav-link @if(request()->routeIs('user.home.event.booking')) active @endif" href="{{route('user.home.event.booking')}}">{{__('Riwayat Event')}}</a>
                                </li>
                            @endif
 ...
 -->
                            <li class="nav-item">
                                <a class="nav-link @if( request()->routeIs('user.leeter.all') || request()->routeIs('user.letter.new') ||request()->routeIs('user.letter.edit')) active @endif " href="{{route('user.letter.all')}}">{{__('Surat List')}}</a>
                            </li>
                     ...
                     <!--        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if(request()->routeIs('user.home.support.tickets')) active @endif" href="{{route('user.home.support.tickets')}}" >{{__('Semua Tiket Pengaduan')}} </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if(request()->routeIs('user.home.verify.update')) active @endif " href="{{route('user.home.verify.update')}}">{{__('Verifikasi Data')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(request()->routeIs('user.home.change.password')) active @endif " href="{{route('user.home.change.password')}}">{{__('Ubah Password')}}</a>
                            </li>
                            <!-- <li class="nav-item">
