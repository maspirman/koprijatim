...
@section('section')
       <div class="headerbtn-wrap d-flex justify-content-between margin-bottom-50">
           <h3 class="header-title">{{__('Create New Letter')}}</h3>
           <a href="{{route('user.letter.all')}}" class="btn btn-info">{{__('All letter List')}}</a>
       </div>
        <form action="{{route('user.letter.new')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  id="event_name" name="event_name" value="{{old('event_name')}}" placeholder="{{__('Nama Acara')}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                             <div class="form-group">
                                                <label for="organizer_phone">{{__('Judul Materi *')}}</label>
                                                <input type="text" class="form-control"  id="letter_materi" name="lesson_materi" value="{{old('lesson_materi')}}" placeholder="{{__('Judul Materi')}}">
                                            </div>
                                        </div>
                                    </div>
