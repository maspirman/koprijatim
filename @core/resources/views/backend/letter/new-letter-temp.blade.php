                ...
                <div class="card">
                    <div class="card-body">
                        <div class="headerbtn-wrap">
                          <div class="row">
                              <div class="col-md-12">
                                  <h4 class="header-title">{{__('Add New Letters Template')}}
                                      <a href="{{route('admin.letter.temp.all')}}" class="btn btn-info pull-right mb-4">{{__('All Letter Template')}}</a>
                                  </h4>
                              </div>
                          </div>

                        </div>
                        <form action="{{route('admin.letter.temp.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="name" name="name" value="{{old('name')}}" placeholder="{{__('Letter Name')}}">
                                    </div>
                                     <div class="form-group">
                                    ...
                                    <button id="submit" type="submit" class="btn btn-primary mt-4 pr-4 pl-4">{{__('Add New Template')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
