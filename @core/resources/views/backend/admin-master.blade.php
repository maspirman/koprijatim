                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu bell-notify-box notify-box">
                                    @if(count($new_notification) > 0)
                                        <span class="notify-title">{{sprintf('Anda memiliki %s notifikasi baru',count($new_notification))}}
                                            <a href="{{route('admin.notification')}}">{{__('semua')}}</a>
                                        </span>
                                    @else
                                        <span class="notify-title">{{__('Anda tidak memiliki notifikasi baru')}}
                                    ...
                                    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 380px;">
                                        <div class="nofity-list">
                                            ...
                                            @foreach($all_notifiacations->sortByDesc('created_at') as $item)
                                                @php
                                                ...
                                                <a href="{{route('admin.notification.view',$item->id)}}" class="notify-item {{$seen_condition}}">
                                                    ...
                                                    <div class="notify-text">
                                                        ...
                                                        @elseif($item->type == 'user_campaign')
                                                         ...
                                                         @elseif($item->type == 'user_letter')
                                                            <p class="pera">{{optional($item->user_letter)->title }}</p>
                                                         @else
