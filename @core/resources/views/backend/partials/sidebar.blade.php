                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li
                        ...
                        @if(request()->is(['admin-home/frontend/new-user','admin-home/frontend/all-user','admin-home/frontend/all-user/role'])) active @endif
                                    ">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i>
                            <span>{{__('Kelola Cabang')}}</span></a>
                        <ul class="collapse">
                            @can('user-list')
                                <li class="{{active_menu('admin-home/frontend/all-user')}}"><a
                                            href="{{route('admin.all.frontend.user')}}">{{__('Semua Cabang')}}</a></li>
                            @endcan
                            @can('branch-create')
                                <li class="{{active_menu('admin-home/frontend/new-user')}}"><a
                                            href="{{route('admin.frontend.new.user')}}">{{__('Buat Cabang Baru')}}</a></li>
                            @endcan
                        </ul>
                    ...
                    >
                        ...
                        <ul class="collapse">
                            ...
                            <li class="{{active_menu('admin-home/support-tickets')}}">
                                <a href="{{route('admin.support.ticket.all')}}">{{__('Semua Tiket')}}</a></li>
                           @endcan
                            @can('support-ticket-create')
                            <li class="{{active_menu('admin-home/support-tickets/new')}}"><a
                                        href="{{route('admin.support.ticket.new')}}">{{__('Tambah Tiket Pengaduan')}}</a></li>
                            @endcan
                            ...
                            <li class="{{active_menu('admin-home/support-tickets/page-settings')}}"><a
                                        href="{{route('admin.support.ticket.page.settings')}}">{{__('Settings')}}</a></li>
                             @endcan
                        </ul>
                    </li>
                 @endcanany
                 @canany(['support-ticket-category-index','support-ticket-page-settings'])
                    ...
                    >
                        ...
                        <ul class="collapse">
                            ...
                            @can('support-ticket-category-index')
                            <li class=""><a
                                        href="{{route('admin.support.ticket.department')}}">{{__('Department')}}</a></li>
                             @endcan
                            @can('support-ticket-category-index')
                            <li class=""><a
                                        href="{{route('admin.support.ticket.department')}}">{{__('Penunjukan')}}</a></li>
                             @endcan
                             @can('support-ticket-page-settings')
                            <li class=""><a
                                        href="{{route('admin.support.ticket.page.settings')}}">{{__('Posisi/Jabatan')}}</a></li>
                             @endcan
                        </ul>
                    </li>
                 @endcanany
