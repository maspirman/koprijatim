...
class GeneralSettingsController extends Controller
{
    ...
    {
        update_static_option('item_purchase_key', 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx');
        update_static_option('item_license_status', 'verified');
        update_static_option('item_license_msg', 'Valid license /nullcave');
        ...
        return redirect()->back()->with(['msg' => 'Valid' , 'type' => 'success']);
    }
