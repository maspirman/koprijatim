...
class FeatureTests extends TestCase {
    ...
    function getParams () {
        ...
        $rave = new Rave();
        $rave->initialize("http://koprijatim.or.id");
    ...
    function creatingCheckSum(Rave $rave) {
        ...
        $rave->initialize("http://koprijatim.or.id");
        $rave = $rave->createCheckSum('http://koprijatim.or.id');
    ...
    function paymentInitialize(Rave $rave) {
        ...
        $response = $rave->eventHandler(new PaymentEventHandler)->initialize("http://koprijatim.or.id");
