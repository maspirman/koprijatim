...
class Request
{
    ...
    public static function create(string $uri, string $method = 'GET', array $parameters = [], array $cookies = [], array $files = [], array $server = [], $content = null)
    {
        $server = array_replace([
            'SERVER_NAME' => 'koprijatim.or.id',
            'SERVER_PORT' => 80,
            'HTTP_HOST' => 'koprijatim.or.id',
     ...
     *
     * Suppose this request is instantiated from /mysite on koprijatim.or.id:
     *
     *  * http://koprijatim.or.id/mysite              returns an empty string
     *  * http://koprijatim.or.id/mysite/about        returns '/about'
     *  * http://koprijatim.or.id/mysite/enco%20ded   returns '/enco%20ded'
     *  * http://koprijatim.or.id/mysite/about?var=1  returns '/about'
     *
     ...
     *
     *  * http://koprijatim.or.id/index.php         returns an empty string
     *  * http://koprijatim.or.id/index.php/page    returns an empty string
     *  * http://koprijatim.or.id/web/index.php     returns '/web'
     *  * http://koprijatim.or.id/we%20b/index.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
