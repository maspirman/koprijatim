...
/*----------------------------------------------------------------------------------------------------------------------------
 ...
 |----------------------------------------------------------------------------------------------------------------------------*/
    ...
    Route::group(['middleware' => 'globalVariable','namespace'=>'Frontend'],function (){
        ...
        Route::get('/events-calendar','FrontendEventController@events_calendar')->name('frontend.events-calendar');
...
|----------------------------------------------------------------------------------------------------------------------------*/
    ...
    Route::get('letter/user', 'FrontendController@user_letter')->name('frontend.letter.user');
    ...
    Route::prefix('user-home')->middleware(['userEmailVerify', 'setlang:frontend', 'globalVariable', 'maintains_mode'])->group(function () {
       ...
       Route::group(['namespace' => 'User'],function (){
        ...
        |------------------------------------------------------*/
       Route::group(['namespace' => 'User'],function (){
           Route::get('/all/letter', 'UserLetterController@all_letter')->name('user.letter.all');
           Route::get('letter/new', 'UserLetterController@new_letter')->name('user.letter.new');
           Route::post('letter/new', 'UserLetterController@store_letter');
           Route::get('letter/edit/{id}', 'UserLetterController@edit_letter')->name('user.letter.edit');
           Route::get('letter/detail/{id}', 'UserLetterController@detail_letter')->name('user.letter.detail');
           Route::get('letter/download/{id}', 'UserLetterController@download_letter')->name('user.letter.download');
           Route::post('/letter/update', 'UserLetterController@update_letter')->name('user.letter.update');
           Route::get('/letter/delete/{id}', 'UserLetterController@delete_letter')->name('user.letter.delete');
       });
    ...
    /*----------------------------------------------------------------------------------------------------------------------------
     ...
     /*----------------------------------------------------------------------------------------------------------------------------
        ...
        Route::group(['prefix' => 'letter', 'namespace' => 'Admin'], function () {
            Route::get('/letter-temp', 'LetterController@all_letters_temp')->name('admin.letter.temp.all');
            Route::post('/letter-temp/new', 'LetterController@store_letter_temp');
            Route::get('/letter-temp/new', 'LetterController@new_letter_temp')->name('admin.letter.temp.new');
            Route::get('/letter-temp/edit/{id}', 'LetterController@edit_letter_temp')->name('admin.letter.temp.edit');
            Route::post('/letter-temp/update', 'LetterController@update_letter_temp')->name('admin.letter.temp.update');
            Route::post('/letter-temp/delete/{id}', 'LetterController@delete_letter_temp')->name('admin.letter.temp.delete');
            Route::post('/letter-temp/clone', 'LetterController@clone_letter_temp')->name('admin.letter.temp.clone');
            Route::post('/letter-temp/lang', 'LetterController@letter_temp_by_language_slug')->name('admin.letter.temp.by.lang');
            Route::post('/letter-temp/bulk-action', 'LetterController@bulk_action')->name('admin.letter.temp.bulk.action');
        ...
        Route::group(['prefix' => 'letter', 'namespace' => 'Admin'], function () {
        Route::get('/letter', 'LetterController@all_letters')->name('admin.letter.all');
        Route::post('/letter/new', 'LetterController@store_letter');
        Route::get('/letter/new', 'LetterController@new_letter')->name('admin.letter.new');
        Route::get('/letter/edit/{id}', 'LetterController@edit_letter')->name('admin.letter.edit');
        Route::get('/letter_download/{id}', 'LetterController@download_letter')->name('admin.letter.download');
        Route::post('/letter/update', 'LetterController@update_letter')->name('admin.letter.update');
        Route::post('/letter/delete/{id}', 'LetterController@delete_letter')->name('admin.letter.delete');
        Route::post('/letter/clone', 'LetterController@clone_letter')->name('admin.letter.clone');
        Route::post('/letter/lang', 'LetterController@letter_by_language_slug')->name('admin.letter.by.lang');
        Route::post('/letter/bulk-action', 'LetterController@bulk_action')->name('admin.letter.bulk.action');
        Route::post('/reminder', 'LetterController@letter_reminder')->name('admin.letter.reminder');
        Route::post('/approve/{id}', 'LetterController@letter_approve')->name('admin.letter.approve');
        Route::get('/approve/{id}', 'LetterController@letter_approve')->name('admin.letter.approve');
        Route::post('/change-status', 'LetterController@change_status')->name('admin.letter.change.status');
        Route::get('letter/detail/{id}', 'LetterController@detail_letter')->name('admin.letter.detail');

    });

     /*----------------------------------------------------------------------------------------------------------------------------
         | LETTER CATEGORY ROUTES
         |----------------------------------------------------------------------------------------------------------------------------*/

        Route::group(['prefix' => 'letter', 'namespace' => 'Admin'], function () {
        Route::get('/category', 'LetterCategoryController@all_letter_category')->name('admin.letter.category.all');
        Route::post('/category/new', 'LetterCategoryController@store_letter_category')->name('admin.letter.category.new');
        Route::post('/category/update', 'LetterCategoryController@update_letter_category')->name('admin.letter.category.update');
        Route::post('/category/delete/{id}', 'LetterCategoryController@delete_letter_category')->name('admin.letter.category.delete');
        Route::post('/category/lang', 'LetterCategoryController@Category_by_language_slug')->name('admin.letter.category.by.lang');
        Route::post('/category/bulk-action', 'LetterCategoryController@bulk_action')->name('admin.letter.category.bulk.action');
